    ...
    <div className="w-full">
      ...
      <section className="bg-accent text-white py-32 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              href="/guide"
              className="px-8 py-3 bg-white text-accent font-semibold rounded hover:bg-opacity-90 transition"
            >
              IB 가이드 보기
            </Link>
            <Link
      ...
      <section className="py-20 px-4 bg-bg">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-text">펀제주 서비스</h2>
      ...
      <section className="py-20 px-4 bg-surface">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-text">펀제주의 약속</h2>

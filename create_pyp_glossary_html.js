...
<div class="container">
  ...
  <div class="glossary" id="glossaryList">
    ...
    <div class="gloss-item">
      ...
      <div class="gloss-pages"><span class="label">사용 페이지</span><a href="./pyp_parent.html">자녀와 대화</a></div>
    </div>
    ...
    <div class="gloss-item">
      ...
      <div class="gloss-pages"><span class="label">사용 페이지</span><a href="./pyp_forms.html">양식</a></div>
    </div>
    ...
    <div class="gloss-item">
      ...
      <div class="gloss-pages"><span class="label">사용 페이지</span><a href="./pyp_forms.html">양식</a><a href="./pyp_parent.html">자녀와 대화</a></div>
    </div>
    ...
    <div class="gloss-item">
      ...
      <div class="gloss-def">한 탐구 단원(UOI)을 이끄는 큰 원리 한 문장. 단원의 "북극성" 같은 존재예요. 학생이 자기 말로 바꿔 설명할 수 있을 때 진짜 이해한 거예요. 예: "사람들은 다양한 방법으로 자신을 표현한다."<span class="myp-connect">MYP에서는 탐구 진술문(SoI, Statement of Inquiry)으로 더 정교해져요. PYP의 CI를 잘 따라가는 습관이 MYP의 SoI 이해의 토대.</span></div>
      <div class="gloss-pages"><span class="label">사용 페이지</span><a href="./pyp_forms.html">양식</a><a href="./pyp_parent.html">자녀와 대화</a></div>
    </div>
...
console.log('Successfully generated pyp_glossary.html');
